...
import aboutback1 from "../images and videos sabitha and co/aboutback1.png"
import aboutback2 from "../images and videos sabitha and co/aboutback1.png"
...
import FullStoreVideo from "../images and videos sabitha and co/videos/FullStoreVideo.mp4"
        ...
        <div className="about-sabithaandco">
                ...
                <div className="image-and-h1-container-about">
                        ...
                        <div className="inside-image-and-h1-container-about">
                                <Tilt>                                        
                                                <img className="product-image" src={aboutback2} alt="logo"  />
                                                <h1  className="product-h1">50000 sqft showroom</h1>                                      
                                </Tilt>
                        </div>
                        <div className="inside-image-and-h1-container-about">
                                <Tilt>                                        
                                                <img className="product-image" src={aboutback1}  alt="logo" />
                                                <h1  className="product-h1">195000 sqft warehousing</h1>                                  
                                </Tilt>
                        </div>                              
                </div>
                <br></br>
